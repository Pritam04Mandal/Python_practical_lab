# To perform the some operation on string 
# length of string
# maximum of string
...
while(choice=="Y" or choice=="y"):
    ...
    if(ch==1):                                               #printing the len of the string
        s=input("Enter the string: ")
        print(s," is of length ",len(s))
    elif(ch==2):                                             #finding the maximum out of three string on the basis of length of string
        ...
        if(len(s1)>len(s2) and len(s1)>len(s3)):
            ...
            print(s3," is Maximum ")
    elif(ch==3):                                             #replacing the vowels with # symbol in the entered string
        s=input("Enter the string: ")
        s1=""
        for i in range(len(s)):
            if(s[i]=='a' or s[i]=='e' or s[i]=='i' or s[i]=='o' or s[i]=='u' or s[i]=='A' or s[i]=='E' or s[i]=='I' or s[i]=='O' or s[i]=='U'):
                ...
                s1+=s[i]
        print("New String: ",s1)
    elif(ch==4):                                             #counting the number of words 
        words=1 
        s=input("Enter the string: ")
        for i in range(len (s)):
            if(s[i]==" "):
    ...
    elif(ch==5):                                             #Cheching the string is palindrome or not
